import { z } from 'zod';
import type { ChatMessage, ChatCompletionResponse, TokenUsage } from '@api-gateway/shared/types.js';
import {
...
export async function runFusion(params: {
  ...
  // Run the panel in waves, refilling failed slots from the overflow chain.
